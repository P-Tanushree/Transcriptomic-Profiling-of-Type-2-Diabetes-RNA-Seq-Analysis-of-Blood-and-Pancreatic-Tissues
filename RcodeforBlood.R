...
count_data <- read_csv('count_blood.csv')
counts_data <- as.data.frame(count_data)
counts_data<-counts_data[1:7]
...
write.csv(res_df, "Blood_results.csv", row.names = TRUE)
cat("DESeq2 results saved to 'Blood_results.csv'\n")
